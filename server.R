  ...
  observeEvent(input$login, {
    ...
    if(input$username != username | input$password != password){
      ...
      withProgress(message = 'Progress...', min = 1,max = 5, {
        ...
        response <- GET(url="https://dl.dropboxusercontent.com/u/76104954/inside_nano/graph_without_genes_also_intra_classes_edges_with_properties80.RData")
        ...
        response <- GET(url="https://dl.dropboxusercontent.com/u/76104954/inside_nano/graph_without_genes_also_intra_classes_edges_network_estimation80_2.RData")
        load(rawConnection(response$content))
        ...
        response <- GET(url="https://dl.dropboxusercontent.com/u/76104954/inside_nano/gene_network_KEGG.RData")
        load(rawConnection(response$content))
        #load("./gene_network_KEGG.RData")
        incProgress(1, detail = "Data Loaded 3/4")
        
        response <- GET(url="https://dl.dropboxusercontent.com/u/76104954/inside_nano/big_net_with_chemical_up_down80_2.RData")
        load(rawConnection(response$content))
...
if(DEBUGGING){
      ...
      output$itemNetwork = renderForceNetwork({
        ...
        forceNetwork(Links = data_frame$edges, Nodes = data_frame$vertices,
                     ...
                     clickAction = MyClickScript5,charge = -500,
