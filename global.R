...
response <- GET(url="https://dl.dropboxusercontent.com/u/76104954/inside_nano/entities.RData")
load(rawConnection(response$content))
#load("./entities.RData")

response <- GET(url="https://dl.dropboxusercontent.com/u/76104954/inside_nano/join10.RData")
load(rawConnection(response$content))
#load("./join10.RData")
join10 = unique(join10)
join10$ATC_lev1 = substr(x = join10$code,start = 1,stop = 1)

response <- GET(url="https://dl.dropboxusercontent.com/u/76104954/inside_nano/chemicals_classes.RData")
load(rawConnection(response$content))
